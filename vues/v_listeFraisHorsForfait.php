        ...
        <table class="table table-bordered table-responsive">
            ...
            <td>
                    ...
                    if (estConnecteComptable()) {
                        ?> <a href="indexcompta.php?uc=validerChoixVisiteur&action=supprimerFrais&idFrais=<?php echo $id?>
                    "onclick="return confirm('Voulez-vous vraiment supprimer ce frais?');">
                            Supprimer ce frais</a> <?php
                    } else {
...
<div class="row">
 ...
 <?php
    if (estConnecteComptable()) {
        ?> <form action="indexcompta.php?uc=validerChoixVisiteur&action=validerCreationFrais" 
                    method="post" role="form"><?php
    } else {

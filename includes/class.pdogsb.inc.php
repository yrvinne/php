...
class PdoGsb
{
    ...
    {
        $requetePrepare = PdoGsb::$_monPdo->prepare(
            "select * from `comptable` where `login`=:leLogin and `mdp`=:leMdp"
        );
        $requetePrepare->bindParam(':leLogin', $login, PDO::PARAM_STR);
        $requetePrepare->bindParam(':leMdp', $mdp, PDO::PARAM_STR);
        $requetePrepare->execute();
        return $requetePrepare->fetch();
    }
    ...
    {
        $requetePrepare = PdoGB::$_monPdo->prepare(
            'UPDATE fichefrais '
    ...
    /**
     * Modifie un  frais hors forfait pour un visiteur un mois donné
     * à partir des informations fournies en paramètre
     *
     * @param String $idVisiteur ID du visiteur
     * @param String $mois       Mois sous la forme aaaamm
     ...
     * @return null
     */
    public function majNouveauFraisHorsForfait(
        $idVisiteur,
        $mois,
        $libelle,
        $date,
    ...
    /**
     * Retoune les noms des visiteurs 
     *
     * @return String 
     */
    public function getVisiteur()
    {
        $requetePrepare = PdoGSB::$_monPdo->prepare('SELECT * FROM visiteur');
        $requetePrepare->execute();
        return $requetePrepare->fetchAll();
    }
    /**
     ...
     * @param String $prenomVisiteur Prenom du visiteur
     * 
    ...
    {
        $requetePrepare = PdoGSB::$_monPdo->prepare(
            "select `id` from `visiteur` where `nom`=:leNom and `prenom`=:lePrenom"
        );
        $requetePrepare->bindParam(':leNom', $nomVisiteur, PDO::PARAM_STR);
        $requetePrepare->bindParam(':lePrenom', $prenomVisiteur, PDO::PARAM_STR);
        $requetePrepare->execute();
        return $requetePrepare->fetch();
    }
}
